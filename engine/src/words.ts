...
export const WORD_LIST: readonly string[] = [
    ...
    'gland', 'glare', 'gleam',
    // Additional 500+ common English words
    'aback', 'abets', 'aches', 'acids', 'acing',
    'acrid', 'adage', 'adobe', 'affix', 'aglow',
    'aides', 'ailed', 'aloof', 'altos', 'amass',
    'amply', 'angst', 'annul', 'antic', 'aping',
    'apron', 'apter', 'arias', 'arson', 'ashed',
    'ashen', 'askew', 'aspen', 'asses', 'aural',
    'auras', 'autos', 'avail', 'avert', 'awing',
    'awoke', 'axing', 'axles', 'babes', 'baggy',
    'bails', 'baits', 'baker', 'balds', 'baled',
    'bales', 'balms', 'bandy', 'bangs', 'barbs',
    'bards', 'bared', 'barer', 'bares', 'barns',
    'baser', 'basks', 'bathe', 'baton', 'bawdy',
    'bawls', 'bayed', 'beady', 'beaks', 'beams',
    'beefs', 'beefy', 'beets', 'befit', 'belch',
    'belie', 'bents', 'beret', 'bests', 'bides',
    'biked', 'bingo', 'biped', 'bison', 'blabs',
    'bland', 'blare', 'bleak', 'bleat', 'bleed',
    'blimp', 'blips', 'blobs', 'blocs', 'blogs',
    'blots', 'blued', 'bluer', 'blurs', 'boars',
    'boast', 'boded', 'bodes', 'boned', 'booby',
    'booed', 'booms', 'boons', 'boors', 'booty',
    'booze', 'bough', 'bouts', 'bowls', 'boxed',
    'brags', 'brats', 'brays', 'brews', 'bribe',
    'brims', 'briny', 'brows', 'brute', 'buddy',
    'buffs', 'bugle', 'bulks', 'bulls', 'bumps',
    'bunks', 'buoys', 'burly', 'burro', 'burrs',
    'bushy', 'busts', 'butte', 'butts', 'buxom',
    'byway', 'cacao', 'cacti', 'caged', 'cages',
    'cagey', 'caked', 'calms', 'calve', 'caned',
    'canes', 'canoe', 'caped', 'capes', 'carat',
    'carol', 'carps', 'carts', 'casks', 'caulk',
    'caved', 'cawed', 'ceded', 'cedes', 'cello',
    'chafe', 'chaff', 'cheep', 'chewy', 'chide',
    'chime', 'chins', 'chirp', 'chows', 'chugs',
    'chums', 'churn', 'chute', 'cigar', 'cinch',
    'clack', 'clams', 'clans', 'cleat', 'clefs',
    'cleft', 'clime', 'cling', 'clink', 'cloak',
    'clods', 'clogs', 'clots', 'clove', 'cluck',
    'clued', 'clump', 'cobra', 'coked', 'cokes',
    'colds', 'colic', 'colts', 'comas', 'combs',
    'cooed', 'coops', 'cored', 'cores', 'corks',
    'corns', 'corny', 'coups', 'coves', 'covet',
    'cowed', 'cower', 'coyer', 'crabs', 'crags',
    'crams', 'craze', 'crepe', 'crept', 'croak',
    'crock', 'crony', 'crook', 'croon', 'crows',
    'crust', 'crypt', 'cubed', 'cubes', 'cuing',
    'culls', 'cults', 'curbs', 'curds', 'curio',
    'curls', 'cuter', 'cysts', 'daddy', 'daisy',
    'dally', 'dames', 'damps', 'dandy', 'darns',
    'daubs', 'daunt', 'dawns', 'dazed', 'dazes',
    'deans', 'dears', 'debit', 'decks', 'deeps',
    'deify', 'deign', 'delis', 'dents', 'diced',
    'dices', 'diets', 'dills', 'dimer', 'dimes',
    'dimly', 'direr', 'disks', 'ditty', 'diver',
    'docks', 'doers', 'doily', 'doled', 'doles',
    'dolls', 'dolly', 'domed', 'domes', 'doped',
    'dopes', 'dopey', 'dosed', 'doted', 'dotes',
    'douse', 'doves', 'downy', 'dozes', 'drabs',
    'dregs', 'droll', 'dross', 'ducts', 'duded',
    'dudes', 'dukes', 'dulls', 'dully', 'dumpy',
    'dungs', 'dunno', 'duped', 'dupes', 'dusts',
    'duvet', 'dwelt', 'earls', 'eased', 'easel',
    'eases', 'edger', 'egged', 'eject', 'eking',
    'elegy', 'elves', 'emirs', 'emits', 'enact',
    'ensue', 'epics', 'erect', 'erred', 'ethos',
    'evict', 'evoke', 'extol', 'fades', 'fairs',
    'faked', 'fakes', 'fared', 'fares', 'fasts',
    'fates', 'fawns', 'fazed', 'fazes', 'fells',
    'felts', 'ferns', 'feted', 'fiche', 'fiend',
    'filch', 'filet', 'filly', 'filmy', 'fishy',
    'fists', 'fives', 'flail', 'flits', 'flogs',
    'flops', 'flora', 'flues', 'foals', 'foams',
    'foist', 'foots', 'fords', 'fores', 'fours',
    'fowls', 'foxed', 'frets', 'frock', 'frond',
    'froth', 'fulls', 'furls', 'fuses', 'gable',
    'gaily', 'galls', 'gamed', 'gamut', 'gaped',
    'gapes', 'garbs', 'gasps', 'gated', 'gaudy',
    'gawks', 'gayer', 'gazed', 'gazes', 'gelds',
    'genie', 'genii', 'gents', 'genus', 'ghoul',
    'giddy', 'gilds', 'gills', 'gimme', 'girth',
    'glade', 'glads', 'glaze', 'glens', 'glide',
    'glint', 'gloat', 'gloom', 'gloss', 'glued',
    'glues', 'gluts', 'gnarl', 'gnash', 'gnats',
    'gnaws', 'goads', 'goats', 'godly', 'golds',
    'golfs', 'goner', 'gongs', 'gonna', 'gooey',
    'goofs', 'goofy', 'goons', 'goose', 'gored',
    'gores', 'gorge', 'gouge', 'gourd', 'gowns',
    'graft', 'grams', 'grate', 'gravy', 'graze',
    'greet', 'grids', 'grill', 'grime', 'grimy',
    'grins', 'gripe', 'grits', 'groin', 'groom',
    'grope', 'growl', 'grubs', 'gruel', 'gruff',
    'grunt', 'guild', 'guile', 'guise', 'gulch',
    'gulfs', 'gulls', 'gully', 'gulps', 'gummy',
    'guppy', 'gurus', 'gusts', 'gusty', 'guyed',
    'hails', 'haled', 'haler', 'hales', 'halon',
    'halos', 'hared', 'harem', 'hares', 'harks',
    'harms', 'harps', 'harry', 'harts', 'haste',
    'hatch', 'hauls', 'haunt', 'haves', 'hawks',
    'hayed', 'hazed', 'hazel', 'hazes', 'heady',
    'heals', 'heaps', 'heath', 'heave', 'hedge',
    'heeds', 'hefty', 'heirs', 'helms', 'herds',
    'heron', 'hewed', 'hicks', 'highs', 'hiked',
    'hiker', 'hikes', 'hilly', 'hilts', 'hinds',
    'hippy', 'hitch', 'hived', 'hives', 'hoard',
] as const;
